const fs = require('fs');
let html = fs.readFileSync('stitch_student_portal_dashboard (2)/code.html', 'utf8');
...
let scripts = `
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        .then(data => {
            if (data.success) {
                document.getElementById('uName').textContent = data.student.name;
                document.getElementById('rollTag').textContent = 'ID: ' + data.student.rollNumber;
                if (data.student.faceIdPhoto) {
                    document.getElementById('uAvatar').innerHTML = '<img src="' + data.student.faceIdPhoto + '" style="width:100%;height:100%;object-fit:cover;">';
                }
            }
        })
...
console.log('Done mapping schedule page!');
